...
if [[ "${COLYNI_FULL_MODEL_CATALOG:-0}" == "1" ]]; then
  ...
  export COLYNI_CLUSTER_MODEL_ALLOWLIST="mlx-community/Llama-3.2-3B-Instruct-8bit,mlx-community/gemma-2-27b-it-4bit,mlx-community/Llama-3.3-70B-Instruct-4bit"
fi

...
from colyni_pyo3_bindings import (
    AllQueuesFullError,
    Keypair,
...
from colyni_cluster.shared.constants import COLYNI_CLUSTER_NODE_ID_KEYPAIR
...
def get_node_id_keypair(
    path: str | bytes | PathLike[str] | PathLike[bytes] = COLYNI_CLUSTER_NODE_ID_KEYPAIR,
) -> Keypair:
    """

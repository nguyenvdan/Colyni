...
from colyni_cluster.shared.constants import COLYNI_CLUSTER_CONFIG_HOME

logger = logging.getLogger(__name__)

_FIRST_RUN_MARKER = COLYNI_CLUSTER_CONFIG_HOME / ".dashboard_opened"
...
"""
    ...
    if first_run:
        ...
        if not (
            os.environ.get("COLYNI_CLUSTER_RUNTIME_DIR")
            or os.environ.get("EXO_RUNTIME_DIR")
        ):
            try:

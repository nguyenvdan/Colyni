...
from colyni_cluster.api.types import ToolCallItem
...
from colyni_cluster.worker.runner.llm_inference.tool_parsers import ToolParser
...
def parse_deepseek_v32(
    ...
    """
    from colyni_cluster.worker.engines.mlx.dsml_encoding import (
        THINKING_END,
        THINKING_START,
        TOOL_CALLS_END,
        TOOL_CALLS_START,
...
def _could_be_dsml_prefix(text: str) -> bool:
    ...
    """
    from colyni_cluster.worker.engines.mlx.dsml_encoding import TOOL_CALLS_START

...
from colyni_cluster.api.types import ImageGenerationStats
from colyni_cluster.shared.constants import COLYNI_CLUSTER_MAX_CHUNK_SIZE, COLYNI_CLUSTER_TRACING_ENABLED
from colyni_cluster.shared.models.model_cards import ModelTask
from colyni_cluster.shared.tracing import clear_trace_buffer, get_trace_buffer
from colyni_cluster.shared.types.chunks import ErrorChunk, ImageChunk
from colyni_cluster.shared.types.common import CommandId, ModelId
...
from colyni_cluster.shared.types.worker.runner_response import (
    ImageGenerationResponse,
    PartialImageResponse,
)
from colyni_cluster.shared.types.worker.runners import (
    RunnerConnected,
    RunnerConnecting,
    RunnerFailed,
    RunnerIdle,
...
from colyni_cluster.shared.types.worker.shards import (
    CfgShardMetadata,
    PipelineShardMetadata,
    ShardMetadata,
)
from colyni_cluster.utils.channels import MpReceiver, MpSender
from colyni_cluster.worker.engines.image import (
...
def _send_traces_if_enabled(
    ...
    if not COLYNI_CLUSTER_TRACING_ENABLED:
        return
...
def _send_image_chunk(
    ...
    data_chunks = [
        encoded_data[i : i + COLYNI_CLUSTER_MAX_CHUNK_SIZE]
        for i in range(0, len(encoded_data), COLYNI_CLUSTER_MAX_CHUNK_SIZE)
    ]

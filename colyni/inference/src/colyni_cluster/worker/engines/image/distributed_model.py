...
from colyni_cluster.api.types import AdvancedImageParams
...
from colyni_cluster.shared.types.worker.shards import CfgShardMetadata, PipelineShardMetadata
from colyni_cluster.worker.engines.image.config import ImageModelConfig
from colyni_cluster.worker.engines.image.models import (
    create_adapter_for_model,
    get_config_for_model,
)
from colyni_cluster.worker.engines.image.models.base import ModelAdapter
from colyni_cluster.worker.engines.image.pipeline import DiffusionRunner
from colyni_cluster.worker.engines.mlx.utils_mlx import mlx_distributed_init, mx_barrier

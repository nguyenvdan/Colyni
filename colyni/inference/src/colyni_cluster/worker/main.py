...
from colyni_cluster.api.types import ImageEditsTaskParams
from colyni_cluster.download.download_utils import resolve_model_in_path
from colyni_cluster.shared.apply import apply
from colyni_cluster.shared.models.model_cards import ModelId
from colyni_cluster.shared.types.commands import (
    ForwarderCommand,
    ForwarderDownloadCommand,
    StartDownload,
)
from colyni_cluster.shared.types.common import CommandId, NodeId, SystemId
...
from colyni_cluster.shared.types.multiaddr import Multiaddr
from colyni_cluster.shared.types.state import State
from colyni_cluster.shared.types.tasks import (
    CancelTask,
    CreateRunner,
    DownloadModel,
    ImageEdits,
...
from colyni_cluster.shared.types.topology import Connection, SocketConnection
from colyni_cluster.shared.types.worker.downloads import DownloadCompleted
from colyni_cluster.shared.types.worker.runners import RunnerId
from colyni_cluster.utils.channels import Receiver, Sender, channel
from colyni_cluster.utils.info_gatherer.info_gatherer import GatheredInfo, InfoGatherer
from colyni_cluster.utils.info_gatherer.net_profile import check_reachable
from colyni_cluster.utils.keyed_backoff import KeyedBackoff
from colyni_cluster.utils.task_group import TaskGroup
from colyni_cluster.worker.plan import plan
from colyni_cluster.worker.runner.runner_supervisor import RunnerSupervisor
            ...
            match task:
                ...
                case DownloadModel(shard_metadata=shard):
                    ...
                    if found_path is not None:
                        logger.info(
                            f"Model {model_id} found in COLYNI_CLUSTER_MODELS_PATH at {found_path}"
                        )
                        await self.event_sender.send(
                            NodeDownloadProgress(

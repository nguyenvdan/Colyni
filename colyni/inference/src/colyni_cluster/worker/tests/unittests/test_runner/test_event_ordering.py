...
import colyni_cluster.worker.runner.llm_inference.batch_generator as mlx_batch_generator
import colyni_cluster.worker.runner.llm_inference.model_output_parsers as mlx_model_output_parsers
import colyni_cluster.worker.runner.llm_inference.runner as mlx_runner
...
from colyni_cluster.shared.types.worker.runner_response import GenerationResponse
...
from colyni_cluster.utils.channels import mp_channel
...
def _run(tasks: Iterable[Task], send_after_ready: list[Task] | None = None):
    ...
    with task_sender:
        ...
        with unittest.mock.patch(
            "colyni_cluster.worker.runner.llm_inference.runner.mx.distributed.all_gather",

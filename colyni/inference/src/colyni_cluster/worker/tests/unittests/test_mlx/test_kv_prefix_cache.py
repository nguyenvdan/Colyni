...
from colyni_cluster.worker.engines.mlx.cache import (
    KVPrefixCache,
    cache_length,
    encode_prompt,
    get_prefix_length,
...
from colyni_cluster.worker.engines.mlx.generator.generate import mlx_generate, prefill
from colyni_cluster.worker.engines.mlx.utils_mlx import apply_chat_template
from colyni_cluster.worker.tests.unittests.test_mlx.conftest import (
...
def _load_gpt_oss() -> tuple[Model, object]:
    ...
    from colyni_cluster.worker.engines.mlx.utils_mlx import load_tokenizer_for_model_id
...
class TestKVPrefixCacheWithModel:
    ...
    def test_evicts_lru_entry_under_memory_pressure(self, model_and_tokenizer):
        ...
        with patch(
            "colyni_cluster.worker.engines.mlx.cache.get_memory_used_percentage",
            return_value=0.95,
        ):

...
from colyni_cluster.download.download_utils import RepoDownloadProgress
from colyni_cluster.download.impl_shard_downloader import SingletonShardDownloader
...
from colyni_cluster.shared.types.common import NodeId, SystemId
from colyni_cluster.shared.types.events import Event, NodeDownloadProgress
...
async def test_re_download_after_delete_completes() -> None:
    ...
    with patch("colyni_cluster.download.coordinator.delete_model", new_callable=AsyncMock):

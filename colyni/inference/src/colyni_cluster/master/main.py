...
from colyni_cluster.shared.constants import COLYNI_CLUSTER_EVENT_LOG_DIR, COLYNI_CLUSTER_TRACING_ENABLED
...
from colyni_cluster.shared.types.common import CommandId, NodeId, SessionId, SystemId
...
from colyni_cluster.shared.types.worker.instances import InstanceId
from colyni_cluster.utils.channels import Receiver, Sender
from colyni_cluster.utils.disk_event_log import DiskEventLog
from colyni_cluster.utils.event_buffer import MultiSourceBuffer
...
class Master:
    def __init__(
        ...
        *,
        ...
        self._event_log = DiskEventLog(COLYNI_CLUSTER_EVENT_LOG_DIR / "master")
                ...
                try:
                    ...
                    match command:
                        ...
                        case ImageGeneration():
                            ...
                            if COLYNI_CLUSTER_TRACING_ENABLED:

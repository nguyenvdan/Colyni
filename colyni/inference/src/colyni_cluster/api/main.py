...
from colyni_cluster.api.adapters.chat_completions import (
    chat_request_to_text_generation,
    collect_chat_response,
    generate_chat_stream,
)
from colyni_cluster.api.adapters.claude import (
    claude_request_to_text_generation,
    collect_claude_response,
    generate_claude_stream,
)
from colyni_cluster.api.adapters.ollama import (
...
from colyni_cluster.api.adapters.responses import (
    collect_responses_response,
    generate_responses_stream,
    responses_request_to_text_generation,
)
from colyni_cluster.api.types import (
...
from colyni_cluster.api.types.claude_api import (
    ClaudeMessagesRequest,
    ClaudeMessagesResponse,
)
from colyni_cluster.api.types.ollama_api import (
    OllamaChatRequest,
    OllamaChatResponse,
...
from colyni_cluster.api.types.openai_responses import (
    ResponsesRequest,
    ResponsesResponse,
)
from colyni_cluster.master.image_store import ImageStore
from colyni_cluster.master.placement import place_instance as get_instance_placements
from colyni_cluster.shared.apply import apply
from colyni_cluster.shared.constants import (
    COLYNI_CLUSTER_DASHBOARD_DIR,
    COLYNI_CLUSTER_CACHE_HOME,
    COLYNI_CLUSTER_EVENT_LOG_DIR,
    COLYNI_CLUSTER_IMAGE_CACHE_DIR,
    COLYNI_CLUSTER_MAX_CHUNK_SIZE,
    COLYNI_CLUSTER_TRACING_CACHE_DIR,
)
from colyni_cluster.shared.election import ElectionMessage
from colyni_cluster.shared.logging import InterceptLogger
from colyni_cluster.shared.models.model_cards import (
    ModelCard,
    ModelId,
    delete_custom_card,
    get_model_cards,
...
from colyni_cluster.shared.types.chunks import (
    ErrorChunk,
    ImageChunk,
    InputImageChunk,
...
from colyni_cluster.shared.types.commands import (
    Command,
    CreateInstance,
    DeleteDownload,
    DeleteInstance,
...
from colyni_cluster.shared.types.common import CommandId, Id, NodeId, SystemId
...
from colyni_cluster.shared.types.worker.instances import Instance, InstanceId, InstanceMeta
from colyni_cluster.shared.types.worker.shards import Sharding
from colyni_cluster.utils.banner import print_startup_banner
from colyni_cluster.utils.channels import Receiver, Sender, channel
from colyni_cluster.utils.disk_event_log import DiskEventLog
from colyni_cluster.utils.power_sampler import PowerSampler
from colyni_cluster.utils.task_group import TaskGroup

_API_EVENT_LOG_DIR = COLYNI_CLUSTER_EVENT_LOG_DIR / "api"
ONBOARDING_COMPLETE_FILE = COLYNI_CLUSTER_CACHE_HOME / "onboarding_complete"
...
class API:
    def __init__(
        ...
        *,
        ...
        self.app.mount(
            "/",
            StaticFiles(
                directory=COLYNI_CLUSTER_DASHBOARD_DIR,
                html=True,
            ),
            name="dashboard",
        )
        ...
        self._image_store = ImageStore(COLYNI_CLUSTER_IMAGE_CACHE_DIR)
    ...
    async def _send_image_edits_command(
        ...
        data_chunks = [
            image_data[i : i + COLYNI_CLUSTER_MAX_CHUNK_SIZE]
            for i in range(0, len(image_data), COLYNI_CLUSTER_MAX_CHUNK_SIZE)
        ]
    ...
    async def ollama_version(self) -> dict[str, str]:
        ...
        return {"version": "colyni-cluster v1.0"}
    ...
    def _save_merged_trace(self, event: TracesMerged) -> None:
        ...
        output_path = COLYNI_CLUSTER_TRACING_CACHE_DIR / f"trace_{event.task_id}.json"
    ...
    def _get_trace_path(task_id: str) -> Path:
        trace_path = COLYNI_CLUSTER_TRACING_CACHE_DIR / f"trace_{task_id}.json"
        if not trace_path.resolve().is_relative_to(COLYNI_CLUSTER_TRACING_CACHE_DIR.resolve()):
    ...
    async def list_traces(self) -> TraceListResponse:
        ...
        for trace_file in sorted(
            COLYNI_CLUSTER_TRACING_CACHE_DIR.glob("trace_*.json"),

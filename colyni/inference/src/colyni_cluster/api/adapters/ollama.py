...
from colyni_cluster.shared.types.common import CommandId
...
def ollama_request_to_text_generation(
    ...
    """Convert Ollama chat request to Colyni cluster internal text generation format."""
...
def ollama_generate_request_to_text_generation(
    ...
    """Convert Ollama generate request to Colyni cluster internal text generation format."""
    chat_template_messages: list[dict[str, Any]] = []
    if request.system:

...
``colyni_cluster.shared.types.text_generation.TextGenerationTaskParams``.
"""
...
from colyni_cluster.shared.types.text_generation import ReasoningEffort
...
class ResponsesRequest(BaseModel, frozen=True):
    ...
    # --- Colyni cluster extensions (not in OpenAI Responses API spec) ---
    enable_thinking: bool | None = Field(
        default=None,
        description="[Colyni cluster extension] Boolean thinking toggle. Not part of the OpenAI Responses API.",
        json_schema_extra={"x-colyni-extension": True},
    )

    top_k: int | None = Field(
        default=None,
        description="[Colyni cluster extension] Top-k sampling parameter. Not part of the OpenAI Responses API.",
        json_schema_extra={"x-colyni-extension": True},
    )
    stop: str | list[str] | None = Field(
        default=None,
        description="[Colyni cluster extension] Stop sequence(s). Not part of the OpenAI Responses API.",
        json_schema_extra={"x-colyni-extension": True},
    )
    seed: int | None = Field(
        default=None,
        description="[Colyni cluster extension] Seed for deterministic sampling. Not part of the OpenAI Responses API.",
        json_schema_extra={"x-colyni-extension": True},
    )
    ...
    chat_template_messages: list[dict[str, Any]] | None = Field(
        ...
        json_schema_extra={"x-colyni-internal": True},
    )

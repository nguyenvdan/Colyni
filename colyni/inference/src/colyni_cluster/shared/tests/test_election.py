...
from colyni_cluster.shared.election import Election, ElectionMessage, ElectionResult
from colyni_cluster.shared.types.commands import ForwarderCommand, TestCommand
from colyni_cluster.shared.types.common import NodeId, SessionId, SystemId
...
def fast_election_timeout(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr("colyni_cluster.shared.election.DEFAULT_ELECTION_TIMEOUT", 0.1)

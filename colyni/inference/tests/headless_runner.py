...
from colyni_cluster.shared.constants import COLYNI_CLUSTER_MODELS_DIR
from colyni_cluster.shared.models.model_cards import ModelCard, ModelId
from colyni_cluster.shared.types.chunks import TokenChunk
from colyni_cluster.shared.types.commands import CommandId
from colyni_cluster.shared.types.common import Host, NodeId
from colyni_cluster.shared.types.events import ChunkGenerated, Event, RunnerStatusUpdated
...
from colyni_cluster.shared.types.text_generation import InputMessage, TextGenerationTaskParams
from colyni_cluster.shared.types.worker.instances import (
    BoundInstance,
    Instance,
    InstanceId,
    MlxJacclInstance,
...
from colyni_cluster.shared.types.worker.shards import PipelineShardMetadata, TensorShardMetadata
from colyni_cluster.utils.channels import channel, mp_channel
from colyni_cluster.utils.info_gatherer.info_gatherer import GatheredInfo, InfoGatherer
from colyni_cluster.worker.runner.bootstrap import entrypoint
...
def list_models():
    sent = set[str]()
    for path in COLYNI_CLUSTER_MODELS_DIR.rglob("model-*.safetensors"):
